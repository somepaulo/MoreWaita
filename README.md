...
![icon](./scalable/apps/freeciv-client.svg "Freeciv")
![icon](./scalable/apps/freeciv-modpack.svg "Freeciv modpack")
![icon](./scalable/apps/freeciv-server.svg "Freeciv server")
...
![icon](./scalable/apps/nelson.svg "Nelson")
...
![icon](./scalable/apps/qtractor.svg "Qtractor")
...
![icon](./scalable/apps/sober.svg "Sober")
...
![icon](./scalable/apps/warp-terminal.svg "Warp Terminal")
...
![icon](./scalable/mimetypes/text-x-ocaml.svg "OCaml")
...
![icon](./scalable/mimetypes/org.rncbc.qtractor.application-x-qtractor-archive.svg "Qtractor archive")
![icon](./scalable/mimetypes/org.rncbc.qtractor.application-x-qtractor-session.svg "Qtractor session")
![icon](./scalable/mimetypes/org.rncbc.qtractor.application-x-qtractor-template.svg "Qtractor template")
...
![icon](./scalable/places/folder-docker.svg "Docker")
...
![icon](./scalable/places/folder-podman.svg "Podman")
...
![icon](./scalable/places/folder-cloud-legacy.svg "Cloud")
...
![icon](./scalable/places/folder-docker-legacy.svg "Docker")
...
![icon](./scalable/places/folder-podman-legacy.svg "Podman")
