...
![icon](./scalable/apps/angryip.svg "Angry IP Scanner")
![icon](./scalable/apps/anki.svg "Anki")
![icon](./scalable/apps/antimicrox.svg "AntiMicroX")
...
![icon](./scalable/apps/io.github.juancarlosbernal.FolderPlay.svg "FolderPlay")
...
![icon](./scalable/apps/helium.svg "Helium")
...
![icon](./scalable/apps/littlesnitch.svg "Little Snitch")
...
![icon](./scalable/apps/com.kagi.Orion.svg "Orion")
...
![icon](./scalable/apps/soundux.svg "Soundux")
...
![icon](./scalable/apps/co.hyprlab.Vireo.svg "Vireo")
...
![icon](./scalable/apps/winecfg.svg "Wine Configuration")
![icon](./scalable/apps/winefile.svg "Wine File")
