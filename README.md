...
Alternatively, if you prefer to have script where you can set a list of folders take a look  at [the custom script](./_dev/custom_folder_icons.sh), you can change to your needs and add it to your dotfiles.
